...
class TestTransactionModel(unittest.TestCase):
    ...
    def test_deposit_to_wallet_success(self):
        ...
        # Act
        result = transaction_model.deposit_to_wallet(customer_id, wallet["id"], amount, reference_id)
    ...
    def test_withdraw_from_wallet(self):
        ...
        # Act
        result = transaction_model.withdraw_from_wallet(customer_id, wallet["id"], amount, reference_id)
    ...
    def test_update_wallet_balance(self):
        ...
        # Act
        result = transaction_model.update_wallet_balance(wallet["id"], "deposit", amount)
